...
//  TODO: Maybe refactor this into main.dart?
void main() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: <Widget>[
          IconButton(
            icon: Icon(Icons.date_range, size: 30.0, color: Colors.white),
            onPressed: null,
          )
        ],
      ),
  ...
  Widget _buildTableCalendar() {
    return TableCalendar(
      ...
      calendarStyle: CalendarStyle(
        selectedColor: Color(0xFF48B9BC), // Teal
        todayColor: Color(0xFF48B9BC), // Teal
        markersColor: Color(0xFF823876), // Purple
    ...
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        ...
        color: _calendarController.isSelected(date)
            ? Colors.purple[300]
            : _calendarController.isToday(date) ? Colors.blueGrey[800] : Colors.purple[300],
      ),
      width: 16.0,
      height: 16.0,
      child: Center(
